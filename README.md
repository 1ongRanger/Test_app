...
1. Скачайте образ по ссылке: https://hub.docker.com/repository/docker/akulovk/precipitation-api/general
2. Запустите образ следующей командой в Docker: docker run -p 8000:8000  akulovk/precipitation-api:1.0.0
3. Для работы с приложением перейдите по следующей ссылке http://127.0.0.1:8000/docs и можете начинать отправлять запросы
